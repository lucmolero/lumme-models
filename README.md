...
Catálogo de produção: https://raw.githubusercontent.com/lucmolero/lumme-models/v1.0.2/catalog.json
...
O catálogo `v1.0.2` já está publicado. O app mantém os plugins embutidos e a
